...
public class MainActivity extends OrmLiteBaseActivity<DatabaseHelper>  {
    ...
    public final static String EXTRA_MESSAGE = "com.example.stackoverflowsearch.app.QUESTION_ID";
    ...
    public void displayQueryResults(final List<QuestionData> list ) {
        ...
        listView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Intent intent = new Intent(view.getContext(), DisplayAnswers.class);
                QuestionData currentQuestionData = (QuestionData) listView.getItemAtPosition(position);
                String questionId = Integer.toString(currentQuestionData.getQuestionId());
                intent.putExtra(EXTRA_MESSAGE,questionId);
                //showToast(questionId);
